...
def load_gui(self):
    ...
    self.textField1 = Entry(self.master, text =self.chooseSrc(self))
    ...
    self.btnFCheck = Button(self.master, text= "File Check",width = 10, height =  3, command= lambda: move_files(self))
