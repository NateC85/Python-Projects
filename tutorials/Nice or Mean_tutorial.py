...
#
#           Remember, function_name(variable) _means that you pass in the variable.
...
def reset(nice,mean,name):
    nice = 0
    mean = 0
    # Notice, you do not reset the name variable as that same user has elected to play again
